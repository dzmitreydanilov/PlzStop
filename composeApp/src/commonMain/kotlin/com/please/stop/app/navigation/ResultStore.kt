...
object LocalResultStore {
    private val compositionLocal: ProvidableCompositionLocal<ResultStore?> =
    ...
    val current: ResultStore
        @Composable
        get() = compositionLocal.current ?: error("No ResultStore has been provided")
    ...
    infix fun provides(
        ...
        return compositionLocal.provides(store)
    }
}
