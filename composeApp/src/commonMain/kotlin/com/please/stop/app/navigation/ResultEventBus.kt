...
object LocalResultEventBus {
    private val compositionLocal: ProvidableCompositionLocal<ResultEventBus?> =
    ...
    val current: ResultEventBus
        @Composable
        get() = compositionLocal.current ?: error("No ResultEventBus has been provided")
    ...
    infix fun provides(
        ...
        return compositionLocal.provides(bus)
    }
}
/**
