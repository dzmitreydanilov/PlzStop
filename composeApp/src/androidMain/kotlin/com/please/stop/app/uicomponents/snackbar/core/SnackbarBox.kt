 ...
 *   Each message carries its own alignment via [SnackbarContent.alignment].
...
fun <T> SnackbarBox(
    ...
    val messageAlignment = when (val state = componentState) {
        is SnackbarState.Hidden -> state.previousMessageContent?.alignment ?: defaultAlignment
        is SnackbarState.Shown -> state.messageContent.alignment
    }
