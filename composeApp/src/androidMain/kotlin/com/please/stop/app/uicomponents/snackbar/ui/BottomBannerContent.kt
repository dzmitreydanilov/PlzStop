...
import dogcare.composeapp.generated.resources.ic_attention
...
fun BottomBannerContent(
    ...
    when (message) {
        is ErrorBannerMessage -> ErrorBannerMessageContent(
        ...
        is InfoBannerMessage -> InfoBannerMessageContent(
            modifier = modifier.semantics { liveRegion = LiveRegionMode.Polite },
            title = message.title,
            ...
            Row {
                Column(
                    ...
                    Row(
                        ...
                        Icon(
                            imageVector = vectorResource(Res.drawable.ic_attention),
                            contentDescription = null,
                        )
                        AutoSizedTitle(text = title)
                    }
